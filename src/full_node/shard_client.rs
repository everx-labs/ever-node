...
use ton_block::{
    BlockIdExt, BlockSignaturesPure, CryptoSignaturePair, CryptoSignature, ConfigParams, 
...
pub async fn load_shard_blocks(
    ...
    if last_mc_state.config_params()?.has_capability(GlobalCapabilities::CapWorkchains) {
