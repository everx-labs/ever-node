...
use ton_api::ton::ton_node::{RempMessageStatus, RempMessageLevel, rempmessagestatus::RempAccepted, RmqRecord};
...
use failure::err_msg;
use ton_api::ton::ton_node::rempmessagestatus::{RempIgnored, RempRejected};
use crate::ext_messages::{is_finally_accepted, is_finally_rejected};
